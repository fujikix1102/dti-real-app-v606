...
# BEGIN APP_READONLY_RUNTIME_SMOKE_PANEL_VISIBLE_WORKSPACE_INSERT_V1
# Read-only visible Workspace insertion.
# Frozen CLASS/classy runtime smoke values only.
# No input widgets.
# No buttons.
# No CLASS call.
# No compute().
...
with st.expander("CLASS / classy runtime smoke identity and frozen values", expanded=True):
...
# END APP_READONLY_RUNTIME_SMOKE_PANEL_VISIBLE_WORKSPACE_INSERT_V1
