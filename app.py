...
import simple_app as _dti_simple_public_entrypoint
...
def _dti_render_strategy_ab_proxy_emulator_public_ready_v1():
    ...
    with st.expander("Strategy A/B proxy-emulator diagnostic — precomputed basin visualization", expanded=False):
        ...
        # DTI_STRATEGY_AB_REAL_PAYLOAD_PROVENANCE_SHA_FINAL_CONSTANT_FIX_V1 BEGIN
        active_real_payload_for_provenance = (str(payload_relpath) == "data/strategy_ab_real_payload_candidate_v1.tsv")
        if active_real_payload_for_provenance:
            displayed_payload_sha256 = "4dd98ed78d8bbddf6b86cb873af918508afe30ee93c520aee4701b78a4fed423"
        # DTI_STRATEGY_AB_REAL_PAYLOAD_PROVENANCE_SHA_FINAL_CONSTANT_FIX_V1 END
...
def _dti_render_desi_dr2_iminuit_product_index_static_payload_v1c():
    """Render DESI DR2 iminuit product-index source/provenance panel.

    Boundary: source/provenance only. No numeric adoption, no chi2,
    no likelihood calculation, no MCMC, no posterior inference, no physical claim.
    """
    payload = {'accepted_small_text_rows': 86, 'boundary': {'bestfit_raw_token_values': 'NO', 'cobaya_chain_sample_read': 'NO', 'computed_chi2': 'NO', 'covariance_chi2_use': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'numeric_adoption': 'NO', 'optimizer_fit_interpretation': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'raw_desi_ingest': 'NO'}, 'display_note': 'DESI DR2 iminuit product index / source provenance only. No numeric adoption, no likelihood, no posterior inference, no physical claim.', 'payload_id': 'DESI_DR2_IMINUIT_PRODUCT_INDEX_STATIC_PAYLOAD_V1', 'preview_rows': [{'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'HASHED', 'product_type': 'readme', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/README.html', 'relative_path': 'README.html', 'row_id': '1', 'source_family_locked': 'README.html', 'source_sha256': '0bc25ea1fd907c11ea88c14d57f031e0c268683ca15582004c4a380bb76f5627'}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/', 'relative_path': 'iminuit/', 'row_id': '2', 'source_family_locked': 'iminuit', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/', 'relative_path': 'iminuit/base/', 'row_id': '3', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_mnu/', 'relative_path': 'iminuit/base_mnu/', 'row_id': '4', 'source_family_locked': 'iminuit/base_mnu', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_mnu059/', 'relative_path': 'iminuit/base_mnu059/', 'row_id': '5', 'source_family_locked': 'iminuit/base_mnu059', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_mnu100/', 'relative_path': 'iminuit/base_mnu100/', 'row_id': '6', 'source_family_locked': 'iminuit/base_mnu100', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_omegak/', 'relative_path': 'iminuit/base_omegak/', 'row_id': '7', 'source_family_locked': 'iminuit/base_omegak', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_omegak_w_wa/', 'relative_path': 'iminuit/base_omegak_w_wa/', 'row_id': '8', 'source_family_locked': 'iminuit/base_omegak_w_wa', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_omegak_wwa/', 'relative_path': 'iminuit/base_omegak_wwa/', 'row_id': '9', 'source_family_locked': 'iminuit/base_omegak_wwa', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_w/', 'relative_path': 'iminuit/base_w/', 'row_id': '10', 'source_family_locked': 'iminuit/base_w', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_w_mnu/', 'relative_path': 'iminuit/base_w_mnu/', 'row_id': '11', 'source_family_locked': 'iminuit/base_w_mnu', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_w_wa/', 'relative_path': 'iminuit/base_w_wa/', 'row_id': '12', 'source_family_locked': 'iminuit/base_w_wa', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_wwa/', 'relative_path': 'iminuit/base_wwa/', 'row_id': '13', 'source_family_locked': 'iminuit/base_wwa', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_wwa_mnu/', 'relative_path': 'iminuit/base_wwa_mnu/', 'row_id': '14', 'source_family_locked': 'iminuit/base_wwa_mnu', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all/', 'relative_path': 'iminuit/base/desi-bao-all/', 'row_id': '15', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_CMB-compressed-theta-ombh2-ombch2/', 'relative_path': 'iminuit/base/desi-bao-all_CMB-compressed-theta-ombh2-ombch2/', 'row_id': '16', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn-zmin0.1_CMB-compressed-theta-ombh2-ombch2/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn-zmin0.1_CMB-compressed-theta-ombh2-ombch2/', 'row_id': '17', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn-zmin0.1_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn-zmin0.1_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'row_id': '18', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn/', 'row_id': '19', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_CMB-compressed-theta-ombh2-ombch2/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_CMB-compressed-theta-ombh2-ombch2/', 'row_id': '20', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE/', 'row_id': '21', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'row_id': '22', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE/', 'row_id': '23', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE_planck-act-dr6-lensing/', 'row_id': '24', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE/', 'row_id': '25', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE_planck-act-dr6-lensing/', 'row_id': '26', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_pantheonplus/', 'relative_path': 'iminuit/base/desi-bao-all_pantheonplus/', 'row_id': '27', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_pantheonplus_CMB-compressed-theta-ombh2-ombch2/', 'relative_path': 'iminuit/base/desi-bao-all_pantheonplus_CMB-compressed-theta-ombh2-ombch2/', 'row_id': '28', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE/', 'row_id': '29', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'row_id': '30', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE/', 'row_id': '31', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE_planck-act-dr6-lensing/', 'row_id': '32', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE/', 'row_id': '33', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_pantheonplus_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE_planck-act-dr6-lensing/', 'row_id': '34', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE/', 'row_id': '35', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'row_id': '36', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE/', 'row_id': '37', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE_planck-act-dr6-lensing/', 'row_id': '38', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE/', 'row_id': '39', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}, {'allowed_display': 'YES', 'computed_chi2': 'NO', 'likelihood': 'NO', 'numeric_adoption': 'NO', 'physical_claim': 'NO', 'posterior_inference': 'NO', 'probe_stage': 'PROBED', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_planck2018-lowl-TT-clik_planck2020-lollipop-lowlE_planck2020-hillipop-TTTEEE_planck-act-dr6-lensing/', 'row_id': '40', 'source_family_locked': 'iminuit/base', 'source_sha256': ''}], 'probe_stage_counts': {'HASHED': 86, 'PROBED': 164}, 'product_type_counts': {'bestfit.minimum.txt': 83, 'directory': 164, 'metadata_txt_or_optimizer_summary': 2, 'readme': 1}, 'row_count': 250, 'source_family_counts': {'README.html': 1, 'iminuit': 1, 'iminuit/base': 62, 'iminuit/base_mnu': 10, 'iminuit/base_mnu059': 8, 'iminuit/base_mnu100': 11, 'iminuit/base_omegak': 37, 'iminuit/base_omegak_w_wa': 30, 'iminuit/base_omegak_wwa': 1, 'iminuit/base_w': 37, 'iminuit/base_w_mnu': 1, 'iminuit/base_w_wa': 49, 'iminuit/base_wwa': 1, 'iminuit/base_wwa_mnu': 1}, 'source_tree_index_sha256': '23330ce6ab0d63c2096042507b63a29d7df517b99c4f186ae1ce0574fc96eb3f'}

    with st.expander("DESI DR2 iminuit product index — source/provenance only", expanded=False):
        st.caption(
            "Source-locked DESI DR2 iminuit product locations and small-text provenance hashes. "
            "This panel is a provenance index only, not a cosmological inference."
        )

        st.markdown(
            "**Boundary:** no numeric adoption, no chi-square evaluation, no likelihood calculation, "
            "no MCMC, no posterior inference, no physical claim, and no optimizer-fit interpretation."
        )

        col1, col2, col3 = st.columns(3)
        col1.metric("Locked index rows", payload.get("row_count", "NA"))
        col2.metric("Accepted small-text rows", payload.get("accepted_small_text_rows", "NA"))
        col3.metric("Preview rows", len(payload.get("preview_rows", [])))

        st.write("Product type counts")
        st.dataframe(
            [
                {"product_type": k, "count": v}
                for k, v in payload.get("product_type_counts", {}).items()
            ],
            use_container_width=True,
            hide_index=True,
        )

        st.write("Source family counts")
        st.dataframe(
            [
                {"source_family": k, "count": v}
                for k, v in payload.get("source_family_counts", {}).items()
            ],
            use_container_width=True,
            hide_index=True,
        )

        st.write("Bounded preview rows")
        st.dataframe(
        ...
        st.code(
            ...
            "posterior_inference=NO\\n"
            "physical_claim=NO\\n"
            "bestfit_raw_token_values=NO\\n"
            "optimizer_fit_interpretation=NO",
            language="text",
        )


_dti_render_desi_dr2_iminuit_product_index_static_payload_v1c()
# --- DTI DESI DR2 iminuit product index static payload V1C END ---

# --- DTI DESI DR2 bao-cosmo-params source map static payload V1B BEGIN ---
def _dti_render_desi_dr2_bao_cosmo_params_source_map_payload_v1b():
    """Render DESI DR2 bao-cosmo-params source/provenance-only payload."""
    try:
        import pandas as pd
    except Exception as exc:
        st.warning(f"pandas import failed for source-map panel: {exc}")
        return

    payload_rows = [{'payload_section': 'summary', 'row_id': 'S1', 'label': 'DESI DR2 bao-cosmo-params source map', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'Source/provenance map only. No numeric adoption, no chi-square computation, no likelihood evaluation, no MCMC run, no posterior-layer claim, and no physical claim.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'summary', 'row_id': 'S2', 'label': 'Locked normalized source-map rows', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '181', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'summary', 'row_id': 'S3', 'label': 'Duplicate URLs retained as provenance context', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'Duplicates are retained with row_id and parent context; they are not independent products.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C4', 'label': 'source_family: README.html', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '2', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C5', 'label': 'source_family: README.md', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '1', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C6', 'label': 'source_family: bao-cosmo-params-root', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '2', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C7', 'label': 'source_family: cobaya', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '1', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C8', 'label': 'source_family: dr2_vac_dr2_bao-cosmo-params_v1.0.sha256sum', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '1', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C9', 'label': 'source_family: iminuit', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '2', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C10', 'label': 'source_family: iminuit/base', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '38', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C11', 'label': 'source_family: iminuit/base_mnu', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '8', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C12', 'label': 'source_family: iminuit/base_mnu059', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '8', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C13', 'label': 'source_family: iminuit/base_mnu100', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '8', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C14', 'label': 'source_family: iminuit/base_omegak', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '25', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C15', 'label': 'source_family: iminuit/base_omegak_w_wa', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '24', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C16', 'label': 'source_family: iminuit/base_omegak_wwa', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '1', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C17', 'label': 'source_family: iminuit/base_w', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '24', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C18', 'label': 'source_family: iminuit/base_w_mnu', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '1', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C19', 'label': 'source_family: iminuit/base_w_wa', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '32', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C20', 'label': 'source_family: iminuit/base_wwa', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '2', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C21', 'label': 'source_family: iminuit/base_wwa_mnu', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '1', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C22', 'label': 'product_type: deferred', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '2', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C23', 'label': 'product_type: directory', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '177', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C24', 'label': 'product_type: readme', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '2', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C25', 'label': 'probe_stage: DEFERRED', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '2', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C26', 'label': 'probe_stage: HASHED', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '1', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C27', 'label': 'probe_stage: PROBED', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '177', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C28', 'label': 'probe_stage: REQUESTED', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '1', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C29', 'label': 'allowed_display: NO', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '2', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'counts', 'row_id': 'C30', 'label': 'allowed_display: YES', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': '179', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '1', 'label': 'bao-cosmo-params-root / directory', 'source_family': 'bao-cosmo-params-root', 'product_group': 'bao-cosmo-params-root', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/', 'relative_path': '', 'source_sha256': 'efb48ed04204bf71d5d8700dacd59bfcc1eadadcbcc9e7ce980d81d8d0730aa9', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '2', 'label': 'README.html / readme', 'source_family': 'README.html', 'product_group': 'README.html', 'product_type': 'readme', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/README.html', 'relative_path': 'README.html', 'source_sha256': '0bc25ea1fd907c11ea88c14d57f031e0c268683ca15582004c4a380bb76f5627', 'probe_stage': 'HASHED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '3', 'label': 'iminuit / directory', 'source_family': 'iminuit', 'product_group': 'iminuit', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/', 'relative_path': 'iminuit/', 'source_sha256': 'c98886a771cdd117d90bb3010dbff5361d7f1baae2b86ec45ee0e3a75462d0c9', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '4', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/', 'relative_path': 'iminuit/base/', 'source_sha256': '59450483b26e6ab7a681bb1b0f909159869ce8321404b2248bdd9f90cfd1d85c', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '5', 'label': 'iminuit/base_mnu / directory', 'source_family': 'iminuit/base_mnu', 'product_group': 'iminuit/base_mnu', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_mnu/', 'relative_path': 'iminuit/base_mnu/', 'source_sha256': '4322ed2772c0110bf3aa37ad33360f772389b77992ce416e82bd22af82447d5a', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '8', 'label': 'iminuit/base_omegak / directory', 'source_family': 'iminuit/base_omegak', 'product_group': 'iminuit/base_omegak', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_omegak/', 'relative_path': 'iminuit/base_omegak/', 'source_sha256': '2335cf12a3093d84f0a17630d82fc2830435208b96145726aa301176f37c9c61', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '10', 'label': 'iminuit/base_w / directory', 'source_family': 'iminuit/base_w', 'product_group': 'iminuit/base_w', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_w/', 'relative_path': 'iminuit/base_w/', 'source_sha256': 'a8e30fa6cbb24b5f7eaad2f36aa1b975fc775566d93d5891d3515102bd41e328', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '11', 'label': 'iminuit/base_w_wa / directory', 'source_family': 'iminuit/base_w_wa', 'product_group': 'iminuit/base_w_wa', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base_w_wa/', 'relative_path': 'iminuit/base_w_wa/', 'source_sha256': '901231ea0521dd9f7a651fefdd292f075fff3b515d41f705ab8c34d07f45aa58', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '13', 'label': 'cobaya / directory', 'source_family': 'cobaya', 'product_group': 'bao-cosmo-params-root', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/cobaya/', 'relative_path': 'cobaya/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '31', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all/', 'relative_path': 'iminuit/base/desi-bao-all/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '32', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_CMB-compressed-theta-ombh2-ombch2/', 'relative_path': 'iminuit/base/desi-bao-all_CMB-compressed-theta-ombh2-ombch2/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '33', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '34', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn-zmin0.1_CMB-compressed-theta-ombh2-ombch2/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn-zmin0.1_CMB-compressed-theta-ombh2-ombch2/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '35', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn-zmin0.1_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn-zmin0.1_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '36', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_CMB-compressed-theta-ombh2-ombch2/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_CMB-compressed-theta-ombh2-ombch2/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '37', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '38', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-TTTEEE_planck-act-dr6-lensing/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'selected_sources', 'row_id': '39', 'label': 'iminuit/base / directory', 'source_family': 'iminuit/base', 'product_group': 'iminuit/base', 'product_type': 'directory', 'public_url': 'https://data.desi.lbl.gov/public/papers/y3/bao-cosmo-params/iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE/', 'relative_path': 'iminuit/base/desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck2018-highl-plik-TTTEEE/', 'source_sha256': 'NA', 'probe_stage': 'PROBED', 'allowed_display': 'YES', 'display_value': 'Public source/provenance link only; no cosmology values are adopted.', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_raw_desi_ingest', 'label': 'raw_desi_ingest', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_large_download', 'label': 'large_download', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_cobaya_chain_sample_read', 'label': 'cobaya_chain_sample_read', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_covariance_chi2_use', 'label': 'covariance_chi2_use', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_bestfit_raw_token_values', 'label': 'bestfit_raw_token_values', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_optimizer_fit_interpretation', 'label': 'optimizer_fit_interpretation', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_numeric_adoption', 'label': 'numeric_adoption', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_computed_chi2', 'label': 'computed_chi2', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_likelihood', 'label': 'likelihood', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_mcmc', 'label': 'mcmc', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_posterior_inference', 'label': 'posterior_inference', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}, {'payload_section': 'boundary', 'row_id': 'B_physical_claim', 'label': 'physical_claim', 'source_family': '', 'product_group': '', 'product_type': '', 'public_url': '', 'relative_path': '', 'source_sha256': '', 'probe_stage': '', 'allowed_display': '', 'display_value': 'NO', 'numeric_adoption': 'NO', 'computed_chi2': 'NO', 'likelihood': 'NO', 'mcmc': 'NO', 'posterior_inference': 'NO', 'physical_claim': 'NO', 'notes': 'source/provenance only'}]

    with st.expander("DESI DR2 bao-cosmo-params source map — provenance only", expanded=False):
        st.caption("Source/provenance map only. No numeric adoption, no chi-square computation, no likelihood evaluation, no MCMC run, no posterior-layer claim, and no physical claim.")
        st.write("Public source/provenance link only; no cosmology values are adopted.")
        st.write("Payload SHA256: `3a45d074ab17cfeba8e38d6ec824ea04863b5dea37a96edd32cd94b8ca4aa828`")
        st.write("Source rows: 181; payload rows: 60.")

        df = pd.DataFrame(payload_rows)
        if df.empty:
            st.info("No source-map payload rows available.")
            return

        summary_df = df[df["payload_section"].isin(["summary", "counts"])]
        selected_df = df[df["payload_section"] == "selected_sources"]
        boundary_df = df[df["payload_section"] == "boundary"]

        st.markdown("**Summary and counts**")
        st.dataframe(
            summary_df[["payload_section", "label", "display_value"]],
            use_container_width=True,
            hide_index=True,
        )

        st.markdown("**Selected source/provenance links**")
        st.dataframe(
            selected_df[["label", "product_type", "public_url", "relative_path", "probe_stage", "allowed_display"]],
            use_container_width=True,
            hide_index=True,
        )
        ...
        st.markdown("**Boundary**")
        st.dataframe(
            boundary_df[["label", "display_value", "numeric_adoption", "computed_chi2", "likelihood", "mcmc", "posterior_inference", "physical_claim"]],
            use_container_width=True,
            hide_index=True,
        )
